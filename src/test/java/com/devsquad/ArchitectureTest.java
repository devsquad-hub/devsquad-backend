...
class ArchitectureTest {
    ...
    static final ArchRule domain_is_framework_independent = noClasses()
            ...
            .should().dependOnClassesThat().resideInAnyPackage(
                    "org.springframework..", "jakarta.persistence..", "org.hibernate..", "software.amazon.awssdk..");
    ...
    static final ArchRule application_does_not_depend_on_infrastructure = noClasses()
            ...
            .should().dependOnClassesThat().resideInAnyPackage(
                    "..adapter..", "org.springframework.jdbc..", "software.amazon.awssdk..", "tools.jackson..");

    @ArchTest
    static final ArchRule inbound_adapters_do_not_access_persistence = noClasses()
