...
public interface ProposalStore {
    ...
    ProposalView approveAndCreate(ProjectProposal proposal, ProposalContent content, String projectSlug, String projectKey);
    ...
    record ProposalContent(
            String title, String summary, String problem, String proposedSolution, String goals, List<String> desiredSkills) {}

    record ProposalView(
            UUID id, UUID hubId, UUID authorId, String authorName, ProposalContent content, String status,
            UUID reviewerId, String decisionReason, UUID projectId, Instant createdAt, Instant updatedAt) {}
}
