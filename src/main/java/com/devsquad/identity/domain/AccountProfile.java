...
public record AccountProfile(
    ...
    public AccountProfile {
        ...
        if (availabilityHours != null && (availabilityHours < 0 || availabilityHours > 168)) {
            throw new DomainException("invalid_availability_hours", "Availability must be between 0 and 168 hours");
        }
    ...
    public static AccountProfile create(
            ...
            String portfolioUrl,
            Integer availabilityHours) {
        return new AccountProfile(displayName, bio, skills, githubUrl, linkedinUrl, portfolioUrl, availabilityHours);
    }
