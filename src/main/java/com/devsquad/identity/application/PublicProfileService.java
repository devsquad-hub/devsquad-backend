...
public class PublicProfileService {
    ...
    public record PublicProfile(UUID id, String displayName, String avatarUrl, String bio, List<String> skills,
                                String githubUrl, String linkedinUrl, String portfolioUrl, Integer availabilityHours,
                                List<ProjectSummary> projects) {}
    public record ProjectSummary(String name, String slug, String hubSlug, String summary, String status,
