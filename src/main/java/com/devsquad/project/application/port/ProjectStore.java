...
public interface ProjectStore {
    ...
    record ProjectView(
            UUID id, UUID hubId, String name, String slug, String projectKey, String summary, String description,
            ProjectStatus status, String repositoryUrl, String communicationUrl, List<String> tags,
            long totalTasks, long completedTasks, List<MemberView> members) {}

    record MemberView(UUID accountId, String displayName, String avatarUrl, String role, String functionalRole) {}

    record ProjectUpdate(
            String name, String summary, String description, String repositoryUrl,
            String communicationUrl, List<String> tags) {}
}
