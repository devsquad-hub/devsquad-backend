...
public class RecruitmentService {
    private static final Set<String> QUESTION_TYPES = Set.of(
            "SHORT_TEXT", "LONG_TEXT", "URL", "SINGLE_CHOICE", "MULTIPLE_CHOICE", "BOOLEAN");
    ...
    @Transactional
    public UUID invite(String clerkId, UUID projectId, UUID accountId, UUID positionId, String functionalRole) {
    ...
    public record PositionCommand(String title, String description, List<String> skills, int capacity,
                                  List<Question> questions) {
        public PositionCommand {
            questions = questions == null ? List.of() : List.copyOf(questions);
        }
    }
    public record Question(String key, String label, String type, boolean required, List<String> options) {}
    public record PositionView(UUID id, UUID roundId, String roundName, String title, String description,
                               List<String> skills, int capacity, int filled, OffsetDateTime closesAt,
                               List<QuestionView> questions) {}
    public record QuestionView(String key, String label, String type, boolean required, List<String> options) {}
    public record ApplicationView(UUID id, UUID positionId, String positionTitle, UUID applicantId,
                                  String applicantName, String applicantAvatarUrl, String answersJson,
